...
const filePath = '/Users/dingwenjiang/.pi/agent/skills/ts-strict-review/SKILL.md';
const typescriptExpertSkill: Skill = {
    name: 'ts-strict-review',
    description: 'A skill that provides expert advice on TypeScript programming, including best practices, design patterns, and advanced techniques.',
    filePath,
    baseDir: path.dirname(filePath),
    sourceInfo: createSyntheticSourceInfo(filePath, { source: 'sdk' }),
